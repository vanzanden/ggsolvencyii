...
knitr::opts_chunk$set(collapse=TRUE,comment="#>",fig.path="z-README-")
library(ggplot2)
...
[![cran Build Status](https://www.r-pkg.org/badges/version/ggsolvencyii)](https://www.r-pkg.org/pkg/ggsolvencyii)
...
## short version
This README is a short version of the vignette 'ggsolvencyii' at https://github.com/vanzanden/ggsolvencyii/tree/master/ which shows more code.
the annotated code of the first example is shown in vignette 'showcase'.
