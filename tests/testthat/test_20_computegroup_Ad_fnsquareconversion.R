...
#    testparams$structure <- sii_z_ex1_structure
    ...
    testresultA <- ggsolvencyii:::fn_squareconversion(df = intresultD, siiparams = testparams)
    testresultAa <- intresultD$db != testresultA$db  ## F,F T F T T ....
